...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _load() async {
    try {
      final res = await widget.api.request('GET', '/api/v1/me/progress', auth: true);
      setState(() {
      ...
      child: FadeRise(
        child: RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              StudentChrome(streakCount: streak, api: widget.api, onSearch: widget.onSearch),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('$pct%', style: t.displayMedium?.copyWith(color: Colors.white)),
                        const Spacer(),
                        Text(
                    ...
                    if (program?['name'] != null) ...[
                      ...
                      Text('${program!['name']}', style: t.bodySmall?.copyWith(color: Colors.white60)),
                    ],
                  ],
                ),
              ),
              ...
              Text('Daily Focus', style: t.headlineSmall?.copyWith(color: AppColors.accent)),
              const SizedBox(height: 14),
              GestureDetector(
                ...
                children: [
                  Expanded(
                    child: _FocusSquare(
                      ...
                      subtitle: '${asInt(daily['flashRemaining'])} left today',
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Initials, city, and points — same program.', style: t.bodySmall),
                        ],
                      ),
                    ),
                    const Icon(Icons.chevron_right_rounded, color: AppColors.muted),
              ...
              const SizedBox(height: 32),
              Text('Subject Mastery', style: t.headlineSmall?.copyWith(color: AppColors.accent)),
              const SizedBox(height: 14),
              if (subjects.isEmpty)
                Text('No subjects in your curriculum yet.', style: t.bodyMedium)
              else
                ...subjects.map((s) {
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Expanded(child: Text('${s['name']}', style: t.titleMedium)),
                              Text(
                                label,
                                style: t.titleMedium?.copyWith(
                                  color: reliable ? AppColors.accent : AppColors.muted,
                                ),
                              ),
                            ],
                          ),
                          ...
                          ClipRRect(
                            ...
                            child: LinearProgressIndicator(
                              ...
                              color: reliable ? AppColors.accent : const Color(0xFFC6C5D4),
                            ),
                          ),
                          if (!reliable) ...[
                            const SizedBox(height: 8),
                            Align(
                              ...
                              child: Text('Needs 5 attempts', style: t.bodySmall),
                            ),
                          ],
                        ],
                      ),
