  ...
  Future<void> _load() async {
    try {
      ...
      if (widget.bookId != null) {
        final bookRes = await widget.api.request(
          'GET',
            ...
            children: [
              if (firstLoad) ...[
                ...
                if (_book != null) ...[
                  ...
                  if (_book!['cta'] != 'study') ...[
                    ...
                    PrimaryButton(
                      label: asInt(_book!['price']) > 0
                          ...
                          : 'Add to study set',
                      onPressed: () async {
                        final ok = await showUnlockBookSheet(
                          context,
                          widget.api,
                          '${_book!['id']}',
                        );
                  ...
                  const SizedBox(height: 20),
                  ...((_book!['chapters'] as List<dynamic>? ?? [])
                      .whereType<Map<String, dynamic>>()
                      .map((ch) {
                          ...
                          child: MeritCard(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${asInt(ch['mcqCount'])} MCQs · ${asInt(ch['flashCount'])} cards',
                                  style: t.bodySmall,
                                ),
                                ...
                                if (canStudy)
                                  ...
                                  Text(
                                    'Locked until you add this book',
                  ...
                  const SizedBox(height: 20),
                  ...((focused['chapters'] as List<dynamic>? ?? [])
                      .whereType<Map<String, dynamic>>()
                      .map((ch) {
                  ...
                  if (subjects.isEmpty)
                    MeritCard(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'No subjects in your study set yet',
                            style: t.titleMedium,
                          ),
                          const SizedBox(height: 8),
                          Text(
                          ...
                          children: [
                            ...
                            if (practice)
                              PrimaryButton(
                                ...
                                onPressed: () =>
                                    widget.onOpenMcq(subjectId: '${s['id']}'),
                              )
                            else
                              SecondaryButton(
                                label: 'Review',
                                onPressed: () => setState(
                                  () => _localSubjectId = '${s['id']}',
                                ),
                              ),
                            TextButton(
                              onPressed: () => setState(
