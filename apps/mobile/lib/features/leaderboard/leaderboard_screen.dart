...
class _LeaderboardScreenState extends State<LeaderboardScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final board = await widget.api.request(
        'GET',
        '/api/v1/leaderboard?scope=GLOBAL',
        auth: true,
      );
      final achs = await widget.api.request(
        'GET',
        ...
        child: _board == null && _error == null
            ? RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: const [LeaderboardSkeleton()],
                ),
              )
            : _board == null
            ? ListView(
                      ...
                      children: [
                        ...
                        if (cityMissing)
                          MeritCard(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Add your city to appear on the board',
                                  style: t.titleMedium,
                                ),
                        ...
                        SizedBox(
                          ...
                          child: preview.isEmpty
                              ? Text(
                                  'Achievements unlock as you study.',
                                  style: t.bodyMedium,
                                )
                              : ListView.separated(
                                    ...
                                    return Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          CircleAvatar(
                                            radius: 28,
                                            backgroundColor: achievementTint(
                                              a['tier']?.toString(),
                                            ),
                                            child: Icon(
                                              achievementIcon(
                            ...
                            children: [
                                    ...
                                    child: Row(
                                      children: [
                                        _TabChip(
                                          ...
                                          onTap: () =>
                                              setState(() => _tab = 'global'),
                                        ),
                                        _TabChip(
                                          label: 'Friends',
                                          selected: _tab == 'friends',
                                          onTap: () =>
                                              setState(() => _tab = 'friends'),
                                        ),
                                      ],
                                    ),
                                  ),
                              ...
                              if (_tab == 'friends')
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: _Podium(row: byRank(2), place: 2),
                                    ),
                                    Expanded(
                                      child: _Podium(row: byRank(1), place: 1),
                                    ),
                                    Expanded(
                                      child: _Podium(row: byRank(3), place: 3),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 20),
          ...
          children: [
            SizedBox(
              ...
              child: Text(
                ...
                textAlign: TextAlign.center,
                style: t.titleMedium?.copyWith(
                  color: you ? AppColors.accent : AppColors.inkSoft,
                ),
              ),
            ),
            const SizedBox(width: 10),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    you ? '${row['initials']} (You)' : '${row['initials']}',
                    style: t.titleMedium,
                  ),
                  Text(
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundColor: locked
                      ...
                      : achievementTint(row['tier']?.toString()),
                  child: Icon(
                    achievementIcon(row['iconKey']?.toString()),
                    color: AppColors.deep,
                  ),
                ),
                const SizedBox(width: 12),
                ...
                if (!locked)
                  Text(
                    '+${asInt(row['pointsReward'])}',
                    style: t.labelLarge?.copyWith(color: AppColors.accent),
                  ),
              ],
            ),
          ),
